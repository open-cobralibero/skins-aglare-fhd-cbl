...
def Plugins(**kwargs):
    return PluginDescriptor(name='CBL Skins V_5.4', description=_('Customization tool for Aglare-FHD-CBL Skin'), where=PluginDescriptor.WHERE_PLUGINMENU, icon='plugin.png', fnc=main)
