...
def Plugins(**kwargs):
    return PluginDescriptor(name='Setup CBL', description=_('Customization tool for Aglare-FHD-CBL Skin'), where=PluginDescriptor.WHERE_PLUGINMENU, icon='plugin.png', fnc=main)
