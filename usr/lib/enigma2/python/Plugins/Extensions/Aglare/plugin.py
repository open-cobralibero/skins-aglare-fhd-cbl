...
def Plugins(**kwargs):
    return PluginDescriptor(name='CBL Skins V_6.5', description=_('Customization tool for Aglare-FHD-CBL Skin'), where=PluginDescriptor.WHERE_PLUGINMENU, icon='plugin.png', fnc=main)
...
class AglareSetup(ConfigListScreen, Screen):
    ...
    def keySave(self):
        ...
        if color_value in COLOR_DIR_MAPPING:
            ...
            window_color_dir = f"/usr/share/enigma2/Aglare-FHD-CBL/main/windowcolor/w_{color_dir}/"
            window_dest_dir = "/usr/share/enigma2/Aglare-FHD-CBL/window/"
