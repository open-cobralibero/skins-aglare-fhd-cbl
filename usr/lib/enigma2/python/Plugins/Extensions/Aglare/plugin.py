...
def Plugins(**kwargs):
    return PluginDescriptor(name='CBL Skins', description=_('Customization tool for Aglare-FHD-CBLSkin'), where=PluginDescriptor.WHERE_PLUGINMENU, icon='plugin.png', fnc=main)
